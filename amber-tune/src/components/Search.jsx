        ...
        >
          ...
          <div className="border bg-red-500 flex items-center justify-center min-w-[2rem] relative">
            ...
            <input
              ...
              className="px-[5%] pl-[4rem]  border  w-full min-w-[5rem] h-[3.8rem]   outline-none bg-amber-100 rounded-3xl rounded-r-none placeholder-amber-900 text-[clamp(1.2rem,1.5vw,1.6rem)]"
            />

            {/* search button */}
            <button
              className="border h-[3.8rem] px-[1.6rem] rounded-3xl rounded-l-none bg-amber-100  text-amber-900"
              type="submit"
            >
              Search
            </button>
